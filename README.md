...
| ORACLE_USER              | Username to use to connect to DB from app and from TestOracleConnection utility                                                                                                                                                                                                                                                    |
| ORACLE_PASS              | Password to use to connect to DB from app and from TestOracleConnection utility                                                                                                                                                                                                                                                    |
| ORACLE_SERVICE           | Oracle Service name to use to connect to DB from app and from TestOracleConnection utility                                                                                                                                                                                                                                         |
...
| WILDFLY_USER             | Optional - Only used with Docker, adds admin user with this name                                                                                                                                                                                                                                                                   |
| WILDFLY_PASS             | Optional - Only used with Docker, adds admin user with this password                                                                                                                                                                                                                                                               |
