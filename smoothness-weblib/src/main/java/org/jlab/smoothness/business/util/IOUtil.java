...
public final class IOUtil {
   ...
   */
  public static String doHtmlGet(String urlStr, int connectTimeout, int readTimeout)
      throws IOException {
    URL url;
  ...
  /**
   * Closes one or more AutoCloseable without generating any checked Exceptions. If an Exception
   * does occur while closing it is logged as a WARNING.
   *
  ...
  /**
   * Return NULL SQL text if the input is null, else a Comma Separated Values (CSV) String with
   * values quoted for SQL.
   *
   * @param array The array of BigInteger values
   * @return A CSV String
   */
