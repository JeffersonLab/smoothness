package org.jlab.smoothness.presentation.controller.setup;
...
public class SettingsSetup extends HttpServlet {
  ...
  protected void doGet(HttpServletRequest request, HttpServletResponse response)
    ...
    List<Setting> settingList = settingsService.filterList(key, tag, offset, max);

    long totalRecords = settingsService.countList(key, tag);

    List<String> tagList = settingsService.findTags();
