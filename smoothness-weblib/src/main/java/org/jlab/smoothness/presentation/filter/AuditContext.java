...
/**
 * Leverages ThreadLocal to share an audit key-value data store across layers of an application for
 * a given HTTP request.
 *
 * <p>Username and request IP address are stored explicitly (outside the generic key-value store) as
 * they are critical audit data.
 *
 * @author ryans
 */
