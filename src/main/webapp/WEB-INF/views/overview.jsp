...
<t:page title="${title}">  
    ...
    <jsp:body>
        <section>
            ...
            <h3>How to Use</h3>
            <p>Create a new Java web project, and use the template CSS, JS, and Jar file.  The Jar file contains JSP Tag files (templating), as well as Filters and Servlets. It is also reasonable to follow the project file layout.  A CDN has been setup to allow easily using minified JS, CSS, and other web dependencies here:  <a href="https://cdn.acc.jlab.org">https://cdn.acc.jlab.org</a>.  You can obtain the Jar file from our internal artifactory repo: http://build.acc.jlab.org/artifactory using Maven/Gradle coordinates org.jlab:smoothness-weblib.</p>
            <h3>Dependences</h3>
            <ul>
